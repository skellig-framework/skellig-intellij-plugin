...
open class SkelligTestStepRefReference(stepParameter: SkelligTestStepFunctionExpression) : SkelligTestStepSimpleReference(stepParameter), PsiPolyVariantReference {
